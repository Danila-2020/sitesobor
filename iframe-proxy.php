<?php
// iframe-proxy.php
// Прокси для загрузки только content-block-wrap с сайта blago-kavkaz.ru

// URL целевого сайта
$targetUrl = 'https://blago-kavkaz.ru/site/articles?catids%5B0%5D=1&title=%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D0%B8&link_id=news';
...
if ($html !== false) {
    ...
    // Находим элемент с классом content-block-wrap или content-wrap
    $xpath = new DOMXPath($dom);
    $contentBlock = $xpath->query('//div[contains(@class, "content-block-wrap")] | //div[contains(@class, "content-wrap")]')->item(0);
    ...
    if ($contentBlock) {
        ...
        echo '<div style="padding: 20px; text-align: center; color: #333;">
                <p>Не удалось загрузить контент с сайта blago-kavkaz.ru</p>
                <p><a href="https://blago-kavkaz.ru/site/articles?catids%5B0%5D=1&title=%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D0%B8&link_id=news" 
                      target="_blank" style="color: #6096b8;">Перейти на сайт</a></p>
              </div>';
    }
} else {
    echo '<div style="padding: 20px; text-align: center; color: #333;">
            <p>Ошибка при загрузке контента с сайта blago-kavkaz.ru</p>
            <p><a href="https://blago-kavkaz.ru/site/articles?catids%5B0%5D=1&title=%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D0%B8&link_id=news" 
                  target="_blank" style="color: #6096b8;">Перейти на сайт</a></p>
          </div>';
}
