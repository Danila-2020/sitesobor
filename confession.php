...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php">
            <img src="img/mestologo.png" width="50" height="50" alt="Логотип">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="sacramentsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Таинства
                    </a>
...
<div class="content-wrapper">
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <div class="img-container">
                    <img src="img/confession-1.jpeg" alt="Таинство Исповеди" class="img-fluid">
                </div>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <h1 class="display-4">Таинство Исповеди</h1>
            </div>
        </div>

        <div class="content-section mt-4">
            <p class="lead">Исповедь — это священное таинство в христианской традиции, которое позволяет верующим очищаться от грехов и восстанавливать свои отношения с Богом. Это важный шаг на пути к духовному возрождению и обновлению.</p>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="highlight-box">
                        <p>"Примите Духа Святого. Кому простите грехи, тому простятся; на ком оставите, на том останутся." (Ин. 20:22-23)</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="img-container">
        ...
        <div class="content-section">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><strong>Слово Божие</strong> — основа для осознания грехов и покаяния.</li>
                        <li class="list-group-item"><strong>Священник</strong> — посредник между верующим и Богом, который исполняет роль духовного наставника.</li>
                        <li class="list-group-item"><strong>Молитва</strong> — средство обращения к Богу за прощением и милостью.</li>
                        <li class="list-group-item"><strong>Крест</strong> — символ искупления и прощения грехов.</li>
                        <li class="list-group-item"><strong>Евангелие</strong> — напоминание о словах и учении Христа.</li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <div class="img-container">
                        <img src="img/confession-3.jpeg" alt="Символы исповеди" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 order-md-2">
                    ...
                    <ol class="list-group list-group-numbered">
                        <li class="list-group-item">Самоанализ и осознание своих грехов.</li>
                        <li class="list-group-item">Молитва о прощении и помощи в покаянии.</li>
                        <li class="list-group-item">Выбор времени и места для исповеди.</li>
                        <li class="list-group-item">Обсуждение с духовным лицом, если это необходимо.</li>
                        <li class="list-group-item">Чтение покаянных молитв и канонов.</li>
                        <li class="list-group-item">Примирение с ближними перед исповедью.</li>
                    </ol>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Признание своих грехов перед Богом и священником.</li>
                        <li class="list-group-item">Совет и наставление от духовного лица.</li>
                        <li class="list-group-item">Чтение разрешительной молитвы.</li>
                        <li class="list-group-item">Получение прощения и благословения.</li>
                        <li class="list-group-item">Выполнение назначенной епитимьи (если требуется).</li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <div class="img-container">
        ...
        <div class="content-section">
            <h2 class="section-title">Духовные плоды Исповеди</h2>
            <div class="row">
                <div class="col-md-6">
                    <p>Исповедь приносит множество духовных благ:</p>
                    <ul class="list-group">
                        <li class="list-group-item">Очищение души от грехов</li>
                        <li class="list-group-item">Примирение с Богом и Церковью</li>
                        <li class="list-group-item">Духовное обновление и укрепление</li>
                        <li class="list-group-item">Мир и спокойствие в душе</li>
                        <li class="list-group-item">Сила для борьбы с искушениями</li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <div class="img-container">
                        <img src="img/confession-6.jpg" alt="Духовные плоды" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content-section">
            ...
            <div class="highlight-box">
                <p class="lead">Исповедь — это не только обряд, но и глубокий духовный процесс, который открывает путь к исцелению души и восстановлению отношений с Богом. Это возможность для каждого верующего начать новую жизнь в благодати и любви Божией.</p>
            </div>
            <div class="text-center mt-4">
                <a href="contacts.php" class="btn btn-primary btn-lg">Записаться на исповедь</a>
            </div>
        </div>
    </div>
