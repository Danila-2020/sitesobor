<?php
// Обработчик полного удаления Духовенства (Пользователь general)
...
if (isset($_POST['submitfulldel'])) {
    ...
    if (!empty($id)) {
        ...
        $sql = "DELETE FROM `clergy` WHERE `id_clergy` = $id";
        ...
        if ($result) {
            echo("<script>alert('Информация о священнике удалена без возможности восстановления!!!');</script>");
